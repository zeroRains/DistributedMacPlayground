...
public class testZipmm {
    public static void main(String[] args) throws Exception {
        ...
        IOUtil.outputMatrixToLocalCSV(CommonConfig.OUTPUT_BUFFER_DIR + "Zipmm/in1.csv", data.in1Block);
        IOUtil.outputMatrixToLocalCSV(CommonConfig.OUTPUT_BUFFER_DIR + "Zipmm/in2.csv", data.in2Block);
